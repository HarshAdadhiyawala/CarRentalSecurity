 ...
 * @author hitesh
 */
@Named(value = "termsJSFManagedBean")
@SessionScoped
//@RequestScoped
public class TermsJSFManagedBean implements Serializable { 
...
int id;
    ...
    public String insertterms()
    {
       ...
       String successmsg1 = njc.InsertTerms(tname);
...
//       return "addcity.xhtml?faces-redirect=true";
       return "viewterms.xhtml?faces-redirect=true";
    }
    ...
    {
        Response rs= njc.ShowTerms(Response.class);
        ArrayList<Terms> clist = new ArrayList<Terms>();
        GenericType<Collection<Terms>> gcterms = new GenericType<Collection<Terms>>() { };
        clist = ( ArrayList<Terms> ) rs.readEntity( gcterms);
        return clist;
    }          
    ...
    public String searchterms(int id1)
    {    
        Response rs = njc.SearchTerms(Response.class, id1);   
        GenericType<Terms> tms = new GenericType<Terms>(){ };
        Terms t= rs.readEntity(tms);
        id= t.getId();
        tname = t.getTerms();
         
        return "editterms.xhtml?faces-redirect=true";       
    }
