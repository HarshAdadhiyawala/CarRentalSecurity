 ...
 * @author hitesh
 */
@Named(value = "contactusJSFManagedBean")
@SessionScoped
//@RequestScoped
public class ContactusJSFManagedBean implements Serializable { 
   ...
   NewJerseyClient njc = new NewJerseyClient();
    ...
    int contactusid;
    String name,email,contactno,subject,contactmessage;
String contactusanswer;

    public String getContactusanswer() {
        return contactusanswer;
    }

    public void setContactusanswer(String contactusanswer) {
        this.contactusanswer = contactusanswer;
    }
    ...
    public String insertcontactus()
    {
        ...
        return "viewuserhome.jsf?faces-redirect=true";
    }
 ...
 public String givecontactusanswer(String sub,String cm,String e,String m)
    {
