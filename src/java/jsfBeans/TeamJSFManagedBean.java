 ...
 * @author hitesh
 */
@Named(value = "teamJSFManagedBean")
@SessionScoped
//@RequestScoped
public class TeamJSFManagedBean implements Serializable { 
   ...
   NewJerseyClient njc = new NewJerseyClient();
    int teamid;
    String tmname,tmgender,tmpost,tmimage,tmdescriptioon,tmjoindate,tmcontactno,tmemaill;
    Date joindate;
    String fname;
    String fnameteam,cityname;
 ...
 String ddate,errmsg;
    ...
    public void setTmpost(String tmpost) {
        this.tmpost = tmpost;
    }
    ...
    public String getTmdescriptioon() {
        return tmdescriptioon;
    }

    public void setTmdescriptioon(String tmdescriptioon) {
        this.tmdescriptioon = tmdescriptioon;
    }
    ...
    public String getTmcontactno() {
        return tmcontactno;
    }

    public void setTmcontactno(String tmcontactno) {
        this.tmcontactno = tmcontactno;
    }

    public String getTmemaill() {
        return tmemaill;
    }

    public void setTmemaill(String tmemaill) {
        this.tmemaill = tmemaill;
    }
    ...
    public String getFnameteam() {
        return fnameteam;
    }

    public void setFnameteam(String fnameteam) {
        this.fnameteam = fnameteam;
    }
    //Team
...
//       return "viewteam.xhtml";
    ...
    public List<Team> showteam()
    {
        ...
        ArrayList<Team> tmlist = new ArrayList<Team>();
        GenericType<Collection<Team>> gcteam = new GenericType<Collection<Team>>() { };
        tmlist = ( ArrayList<Team> ) rs.readEntity( gcteam);
//        teamcnt = tmlist.size();
        return tmlist;
    }          
    ...
    {    
        ...
        GenericType<Team> gteam = new GenericType<Team>(){ };
        Team t = rs.readEntity(gteam);
        teamid=t.getTeamid();
        tmname=t.getName();
