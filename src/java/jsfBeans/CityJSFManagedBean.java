 ...
 * @author hitesh
 */
@Named(value = "cityJSFManagedBean")
@SessionScoped
//@RequestScoped
public class CityJSFManagedBean implements Serializable { 
...
int cityid;
    ...
    public String insertcity()
    {
       ...
       String successmsg1 = njc.InsertCity(cityname);
...
//       return "addcity.xhtml?faces-redirect=true";
       return "viewcity.xhtml?faces-redirect=true";
    }
    ...
    {
        Response rs= njc.ShowCity(Response.class);
        ArrayList<City> clist = new ArrayList<City>();
        GenericType<Collection<City>> gccity = new GenericType<Collection<City>>() { };
        clist = ( ArrayList<City> ) rs.readEntity( gccity);
        return clist;
    }          
    ...
    public String searchcity(int id)
    {    
        Response rs = njc.SearchCity(Response.class, id);   
        GenericType<City> gcity = new GenericType<City>(){ };
        City ct= rs.readEntity(gcity);
        cityid= ct.getId();
    ...
    public String updatecity()
    {
       ...
       c.setId(cityid);
       c.setCityname(cityname);
       njc.UpdateCity(cityid, cityname);
       return "viewcity.xhtml?faces-redirect=true";
    }
